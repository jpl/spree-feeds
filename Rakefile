...
desc 'Generate documentation for the feeds extension.'
Rake::RDocTask.new(:rdoc) do |rdoc|
  rdoc.rdoc_dir = 'rdoc'
  rdoc.title    = 'FeedsExtension'
...
namespace :test do
  desc 'Functional test the feeds extension.'
  ...
  desc 'Unit test the feeds extension.'
